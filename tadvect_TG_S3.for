...
******************************************************
      ...
      parameter (itermax=0, omega=1.0)  ! iteration parameters
...
*     Mass matrix invertion 
	...
	sum= c4*(HZK1*(sumk+sumkm) +HZK*(sumkp+sumkpp))
...
c     Crosswind and background diffusion
	a11(1)= a_11 +C1*a_22 +C2*a_33 +a
	a12(1)= a_12 -C1*a_12
	a13(1)= a_13 -C2*a_13
	a23(1)= a_23 -C2*a_23
	a22(1)= a_22 +C1*a_11 +C2*a_33 +a
	a33(1)= a_33 +C2*(a_11+a_22)
...
c     Crosswind and background diffusion
	a11(2)= a_11 +C1*a_22 +C2*a_33 +a
	a12(2)= a_12 -C1*a_12
	a13(2)= a_13 -C2*a_13
	a23(2)= a_23 -C2*a_23
	a22(2)= a_22 +C1*a_11 +C2*a_33 +a
	a33(2)= a_33 +C2*(a_11+a_22)
...
c     Crosswind and background diffusion
	a11(3)= a_11 +C1*a_22 +C2*a_33 +a
	a12(3)= a_12 -C1*a_12
	a13(3)= a_13 -C2*a_13
	a23(3)= a_23 -C2*a_23
	a22(3)= a_22 +C1*a_11 +C2*a_33 +a
	a33(3)= a_33 +C2*(a_11+a_22)
...
c     Crosswind and background diffusion
	a11(4)= a_11 +C1*a_22 +C2*a_33 +a
	a12(4)= a_12 -C1*a_12
	a13(4)= a_13 -C2*a_13
	a23(4)= a_23 -C2*a_23
	a22(4)= a_22 +C1*a_11 +C2*a_33 +a
	a33(4)= a_33 +C2*(a_11+a_22)
...
c     Crosswind and background diffusion
	a11(5)= a_11 +C1*a_22 +C2*a_33 +a
	a12(5)= a_12 -C1*a_12
	a13(5)= a_13 -C2*a_13
	a23(5)= a_23 -C2*a_23
	a22(5)= a_22 +C1*a_11 +C2*a_33 +a
	a33(5)= a_33 +C2*(a_11+a_22)
...
c     Crosswind and background diffusion
	a11(6)= a_11 +C1*a_22 +C2*a_33 +a
	a12(6)= a_12 -C1*a_12
	a13(6)= a_13 -C2*a_13
	a23(6)= a_23 -C2*a_23
	a22(6)= a_22 +C1*a_11 +C2*a_33 +a
	a33(6)= a_33 +C2*(a_11+a_22)
