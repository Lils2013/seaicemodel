...
*     Diffusion in general form div(Aij*Grad(S))
*     Result is in the RST
...
c     -------------------------------
c     Gradient multiplyed by diffusion coefficients

c     Triangle # 1.

c     Horizontal part of the operator
      DIFT= DIFT +KT(1,n)*0.5*(
     &     a11(1)*(T(I+1,J,K)-T(I  ,J,  K))/S1
...
c     Horizontal part of the operator
      DIFTP= DIFTP+0.5*KT(1,np)*(a11(1)*(T(I+1,J,K)-T(I,J,K))/S1
...
c     Horizontal part of the operator
      DIFTP= DIFTP+0.5*KT(3,np)*(a11(3)*(T(I-1,J,K)-T(I,J,K))/S3
     &            +asr*a12(3)*(T(i,j-1,k)-T(i,j,k))
     &            -asr*a12(3)*(T(i,j,k)-T(i-1,j,k))
...
c     Horizontal part of the operator
      DIFTP= DIFTP+0.5*KT(4,np)*(a11(4)*(T(I-1,J,K)-T(I,J,K))/S4
...
c     Horizontal part of the operator
      DIFTP= DIFTP+0.5*KT(6,np)*(a11(6)*(T(I+1,J,K)-T(I,J,K))/S6
