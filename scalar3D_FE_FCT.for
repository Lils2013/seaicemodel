...
*******************************************************
      ...
      parameter (itermax=5, omega=1.0)    ! Iteration parameters
...
*     -------------- Surface -----------------
      ...
      Sum1= c24*
     * (KT(1,n)*(2.*Sclr2(i,j,1)+Sclr2(i+1,j,1)+Sclr2(i+1,j-1,1))
     + +KT(2,n)*(2.*Sclr2(i,j,1)+Sclr2(i,j-1,1)+Sclr2(i+1,j-1,1))
     + +KT(3,n)*(2.*Sclr2(i,j,1)+Sclr2(i,j-1,1)+Sclr2(i-1,j  ,1))
     + +KT(4,n)*(2.*Sclr2(i,j,1)+Sclr2(i-1,j,1)+Sclr2(i-1,j+1,1))
     + +KT(5,n)*(2.*Sclr2(i,j,1)+Sclr2(i-1,j+1,1)+Sclr2(i,j+1,1))
     + +KT(6,n)*(2.*Sclr2(i,j,1)+Sclr2(i,j+1,1)+Sclr2(i+1,j  ,1)))

      Sum2= c24*
     * (KT(1,n)*(2.*Sclr2(i,j,2)+Sclr2(i+1,j,2)+Sclr2(i+1,j-1,2))
     + +KT(2,n)*(2.*Sclr2(i,j,2)+Sclr2(i,j-1,2)+Sclr2(i+1,j-1,2))
     + +KT(3,n)*(2.*Sclr2(i,j,2)+Sclr2(i,j-1,2)+Sclr2(i-1,j  ,2))
     + +KT(4,n)*(2.*Sclr2(i,j,2)+Sclr2(i-1,j,2)+Sclr2(i-1,j+1,2))
     + +KT(5,n)*(2.*Sclr2(i,j,2)+Sclr2(i-1,j+1,2)+Sclr2(i,j+1,2))
     + +KT(6,n)*(2.*Sclr2(i,j,2)+Sclr2(i,j+1,2)+Sclr2(i+1,j  ,2)))

      FZT=-0.5*S0*((Sum1+Sum2)*W(i,j,2) -2.*Sum1*(W(i,j,1)-PME(i,j)/dt))

      ELSE
*     --------------  Deep water -------------

      Sum1= c24*
     * (KT(1,n)*(2.*Sclr2(i,j,k)+Sclr2(i+1,j,k)+Sclr2(i+1,j-1,k))
     + +KT(2,n)*(2.*Sclr2(i,j,k)+Sclr2(i,j-1,k)+Sclr2(i+1,j-1,k))
     + +KT(3,n)*(2.*Sclr2(i,j,k)+Sclr2(i,j-1,k)+Sclr2(i-1,j  ,k))
     + +KT(4,n)*(2.*Sclr2(i,j,k)+Sclr2(i-1,j,k)+Sclr2(i-1,j+1,k))
     + +KT(5,n)*(2.*Sclr2(i,j,k)+Sclr2(i-1,j+1,k)+Sclr2(i,j+1,k))
     + +KT(6,n)*(2.*Sclr2(i,j,k)+Sclr2(i,j+1,k)+Sclr2(i+1,j  ,k)))

      Sum1m= c24*
     * (KT(1,n)*(2.*Sclr2(i,j,km)+Sclr2(i+1,j,km)+Sclr2(i+1,j-1,km))
     + +KT(2,n)*(2.*Sclr2(i,j,km)+Sclr2(i,j-1,km)+Sclr2(i+1,j-1,km))
     + +KT(3,n)*(2.*Sclr2(i,j,km)+Sclr2(i,j-1,km)+Sclr2(i-1,j  ,km))
     + +KT(4,n)*(2.*Sclr2(i,j,km)+Sclr2(i-1,j,km)+Sclr2(i-1,j+1,km))
     + +KT(5,n)*(2.*Sclr2(i,j,km)+Sclr2(i-1,j+1,km)+Sclr2(i,j+1,km))
     + +KT(6,n)*(2.*Sclr2(i,j,km)+Sclr2(i,j+1,km)+Sclr2(i+1,j  ,km))
     *                                                                )

      Sum2= c24*
     * (KT(1,np)*(2.*Sclr2(i,j,k)+Sclr2(i+1,j,k)+Sclr2(i+1,j-1,k))
     + +KT(2,np)*(2.*Sclr2(i,j,k)+Sclr2(i,j-1,k)+Sclr2(i+1,j-1,k))
     + +KT(3,np)*(2.*Sclr2(i,j,k)+Sclr2(i,j-1,k)+Sclr2(i-1,j  ,k))
     + +KT(4,np)*(2.*Sclr2(i,j,k)+Sclr2(i-1,j,k)+Sclr2(i-1,j+1,k))
     + +KT(5,np)*(2.*Sclr2(i,j,k)+Sclr2(i-1,j+1,k)+Sclr2(i,j+1,k))
     + +KT(6,np)*(2.*Sclr2(i,j,k)+Sclr2(i,j+1,k)+Sclr2(i+1,j  ,k)))

      Sum2p= c24*
     * (KT(1,np)*(2.*Sclr2(i,j,kp)+Sclr2(i+1,j,kp)+Sclr2(i+1,j-1,kp))
     + +KT(2,np)*(2.*Sclr2(i,j,kp)+Sclr2(i,j-1,kp)+Sclr2(i+1,j-1,kp))
     + +KT(3,np)*(2.*Sclr2(i,j,kp)+Sclr2(i,j-1,kp)+Sclr2(i-1,j  ,kp))
     + +KT(4,np)*(2.*Sclr2(i,j,kp)+Sclr2(i-1,j,kp)+Sclr2(i-1,j+1,kp))
     + +KT(5,np)*(2.*Sclr2(i,j,kp)+Sclr2(i-1,j+1,kp)+Sclr2(i,j+1,kp))
     + +KT(6,np)*(2.*Sclr2(i,j,kp)+Sclr2(i,j+1,kp)+Sclr2(i+1,j  ,kp))
     *                                                                 )

      FZT=-0.5*S0*( (Sum2+Sum2p)*W(i,j,Kp) -(Sum1+Sum1m)*W(i,j,K) )
      END IF
...
cc	Sclr1(i,j,k)= RsT(i,j,k)/( r2s12*(CG(n)*HZK1+CG(np)*HZK))
	Sclr1(i,j,k)= RsT(i,j,k)/sclamp(i,j,k)
...
cc	Sclr1(i,j,kb)= RsT(i,j,kb)/( r2s12*CG(n)*HZ(KB-1))
	Sclr1(i,j,kb)= RsT(i,j,kb)/sclamp(i,j,kb)
...
cc     *        + omega*(RsT(i,j,k)-sum)/( r2s12*(CG(n)*HZK1+CG(np)*HZK))
...
*     Element 1
     ...
     *KT(1,n)*S1*(2.*Sclr2(i,j,km)+Sclr2(i+1,j,km)+Sclr2(i+1,j-1,km))
      ...
      Sum1= c12*S1*KT(1,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
	...
	Sum2= c12*S1*KT(1,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm)

      antidf(1,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 2
     ...
     *KT(2,n)*S2*(2.*Sclr2(i,j,km)+Sclr2(i,j-1,km)+Sclr2(i+1,j-1,km))
      ...
      Sum1= c12*S2*KT(2,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
	...
	Sum2= c12*S2*KT(2,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm)

      antidf(2,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 3
     ...
     *KT(3,n)*S3*(2.*Sclr2(i,j,km)+Sclr2(i,j-1,km)+Sclr2(i-1,j  ,km))
      ...
      Sum1= c12*S3*KT(3,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
     ...
     *KT(3,n)*S3*(2.*Sclr1(i,j,km)+Sclr1(i,j-1,km)+Sclr1(i-1,j  ,km))
      ...
      Sum2= c12*S3*KT(3,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 

      antidf(3,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 4
     ...
     *KT(4,n)*S4*(2.*Sclr2(i,j,km)+Sclr2(i-1,j,km)+Sclr2(i-1,j+1,km))
      ...
      Sum1= c12*S4*KT(4,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
     ...
     *KT(4,n)*S4*(2.*Sclr1(i,j,km)+Sclr1(i-1,j,km)+Sclr1(i-1,j+1,km))
      ...
      Sum2= c12*S4*KT(4,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 

      antidf(4,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 5
     ...
     *KT(5,n)*S5*(2.*Sclr2(i,j,km)+Sclr2(i-1,j+1,km)+Sclr2(i,j+1,km))
      ...
      Sum1= c12*S5*KT(5,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
     ...
     *KT(5,n)*S5*(2.*Sclr1(i,j,km)+Sclr1(i-1,j+1,km)+Sclr1(i,j+1,km))
      ...
      Sum2= c12*S5*KT(5,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 

      antidf(5,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 6
     ...
     *KT(6,n)*S6*(2.*Sclr2(i,j,km)+Sclr2(i,j+1,km)+Sclr2(i+1,j  ,km))
      ...
      Sum1= c12*S6*KT(6,n)*Sclr2(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 
     ...
     *KT(6,n)*S6*(2.*Sclr1(i,j,km)+Sclr1(i,j+1,km)+Sclr1(i+1,j  ,km))
      ...
      Sum2= c12*S6*KT(6,n)*Sclr1(i,j,k)*HZK1 - c6*HZK1*(2.*sumk+sumkm) 

      antidf(6,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 7
     ...
     *KT(1,np)*S1*(2.*Sclr2(i,j,kp)+Sclr2(i+1,j,kp)+Sclr2(i+1,j-1,kp))
      ...
      Sum1= c12*S1*KT(1,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
	...
	Sum2= c12*S1*KT(1,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp)

      antidf(7,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 8
     ...
     *KT(2,np)*S2*(2.*Sclr2(i,j,kp)+Sclr2(i,j-1,kp)+Sclr2(i+1,j-1,kp))
      ...
      Sum1= c12*S2*KT(2,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
	...
	Sum2= c12*S2*KT(2,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp)

      antidf(8,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 9
     ...
     *KT(3,np)*S3*(2.*Sclr2(i,j,kp)+Sclr2(i,j-1,kp)+Sclr2(i-1,j  ,kp))
      ...
      Sum1= c12*S3*KT(3,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
     ...
     *KT(3,np)*S3*(2.*Sclr1(i,j,kp)+Sclr1(i,j-1,kp)+Sclr1(i-1,j  ,kp))
      ...
      Sum2= c12*S3*KT(3,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 

      antidf(9,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 10
     ...
     *KT(4,np)*S4*(2.*Sclr2(i,j,kp)+Sclr2(i-1,j,kp)+Sclr2(i-1,j+1,kp))
      ...
      Sum1= c12*S4*KT(4,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
     ...
     *KT(4,np)*S4*(2.*Sclr1(i,j,kp)+Sclr1(i-1,j,kp)+Sclr1(i-1,j+1,kp))
      ...
      Sum2= c12*S4*KT(4,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 

      antidf(10,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 11
     ...
     *KT(5,np)*S5*(2.*Sclr2(i,j,kp)+Sclr2(i-1,j+1,kp)+Sclr2(i,j+1,kp))
      ...
      Sum1= c12*S5*KT(5,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
     ...
     *KT(5,np)*S5*(2.*Sclr1(i,j,kp)+Sclr1(i-1,j+1,kp)+Sclr1(i,j+1,kp))
      ...
      Sum2= c12*S5*KT(5,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 

      antidf(11,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
*     Element 12
     ...
     *KT(6,np)*S6*(2.*Sclr2(i,j,kp)+Sclr2(i,j+1,kp)+Sclr2(i+1,j  ,kp))
      ...
      Sum1= c12*S6*KT(6,np)*Sclr2(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 
     ...
     *KT(6,np)*S6*(2.*Sclr1(i,j,kp)+Sclr1(i,j+1,kp)+Sclr1(i+1,j  ,kp))
      ...
      Sum2= c12*S6*KT(6,np)*Sclr1(i,j,k)*HZK - c6*HZK*(2.*sumk+sumkp) 

      antidf(12,i,j,k)= (gamma_fct*Sum1+Sum2) *QQQ 
...
c      delta_t=T(i+1,j,k)
c	delta_x=(T(i+1,j,k)+Tm2(i+1,j,k)
c     *        -T(i+2,j,k)-Tm2(i+2,j,k))/(R*hx*S0)
c	sss= delta_t*(Tm2(i+1,j+1,k)-Tm2(i+1,j-1,k))

c	if(sss.GT.0.)then
c	delta_y=(Tm2(i+1,j,k)-Tm2(i+1,j-1,k))/(R*hy)
c	else
c	delta_y=(Tm2(i+1,j+1,k)-Tm2(i+1,j,k))/(R*hy)
c	end if

c      D= 1./MAX(1.e-12,delta_x**2 + delta_y**2)
c	Rx=-delta_t*delta_x*D/(R*hx*S0)
c	Ry=-delta_t*delta_y*D/(R*hy)
...
*     Upwind scheme
c      un= -v(i,j,k)
c	T(i,j,k)=dt*((un-abs(un))*(Tm2(i,j-1,k)-Tm2(i,j,k)) +
c     +             (un+abs(un))*(Tm2(i,j  ,k)-Tobs(i,j,k)) )/(R*hy)

c      delta_t= T(i,j-1,k)
c	delta_x=(T(i,j-1,k)+Tm2(i,j-1,k)
c     *        -T(i,j-2,k)-Tm2(i,j-2,k))/(R*hy)
c	sss= delta_t*(Tm2(i+1,j-1,k)-Tm2(i-1,j-1,k))

c	if(sss.GT.0.)then
c	delta_y=(Tm2(i,j-1,k)-Tm2(i-1,j-1,k))/(R*hx*S0)
c	else
c	delta_y=(Tm2(i+1,j-1,k)-Tm2(i,j-1,k))/(R*hx*S0)
c	end if

c      D= 1./MAX(1.e-12,delta_x**2 + delta_y**2)
c	Rx=-delta_t*delta_x*D/(R*hy)
c	Ry=-delta_t*delta_y*D/(R*hx*S0)
...
c	Rx= Rx +dt*u(i-1,j,k)/(R*hx*S0)
c	Ry= Ry -dt*v(i-1,j,k)/(R*hy)
c	Rx= Rx +dt*u(i,j,k)/(R*hx*S0)
c	Ry= Ry -dt*v(i,j,k)/(R*hy)
...
c	Rx= Rx -dt*v(i,j+1,k)/(R*hy)
c	Ry= Ry -dt*u(i,j+1,k)/(R*hx*S0)
c	Rx= Rx -dt*v(i,j,k)/(R*hy)
c	Ry= Ry -dt*u(i,j,k)/(R*hx*S0)
...
c     dT/dz*dfi/dlambda
      DIFT= DIFT +KT(1,n)*Rhx*c12*a13(1)*(Q1K-Q1Km)
...
c     dT/dz*dfi/dteta
      DIFT= DIFT -KT(2,n)*Rhy*S2*c12*a23(2)*asr*(Q2K-Q2Km)
...
c     dT/dz*dfi/dlambda
      DIFT= DIFT -KT(3,n)*Rhx*c12*a13(3)*(Q3K-Q3Km)
...
c     dT/dz*dfi/dteta
      DIFT= DIFT -KT(3,n)*Rhy*S3*c12*a23(3)*asr*(Q3K-Q3Km)
...
c     dT/dz*dfi/dlambda
      DIFT= DIFT -KT(4,n)*Rhx*c12*a13(4)*(Q4K-Q4Km)
...
c     dT/dz*dfi/dteta
      DIFT= DIFT +KT(5,n)*Rhy*S5*c12*a23(5)*asr*(Q5K-Q5Km)
...
c     dT/dz*dfi/dlambda
      DIFT= DIFT +KT(6,n)*Rhx*c12*a13(6)*(Q6K-Q6Km)
...
c     dT/dz*dfi/dteta
      DIFT= DIFT +KT(6,n)*Rhy*S6*c12*a23(6)*asr*(Q6K-Q6Km)
...
c     dT/dz*dfi/dlambda
      DIFTP= DIFTP +KT(1,np)*Rhx*c12*a13(1)*(Q1Kp-Q1K)
...
c     dT/dz*dfi/dteta
      DIFTP= DIFTP -KT(2,np)*Rhy*S2*c12*a23(2)*asr*(Q2Kp-Q2K)
...
c     dT/dz*dfi/dlambda
      DIFTP= DIFTP -KT(3,np)*Rhx*c12*a13(3)*(Q3Kp-Q3K)
...
c     dT/dz*dfi/dteta
      DIFTP= DIFTP -KT(3,np)*Rhy*S3*c12*a23(3)*asr*(Q3Kp-Q3K)
...
c     dT/dz*dfi/dlambda
      DIFTP= DIFTP -KT(4,np)*Rhx*c12*a13(4)*(Q4Kp-Q4K)
...
c     dT/dz*dfi/dteta
      DIFTP= DIFTP +KT(5,np)*Rhy*S5*c12*a23(5)*asr*(Q5Kp-Q5K)
...
c     dT/dz*dfi/dlambda
      DIFTP= DIFTP +KT(6,np)*Rhx*c12*a13(6)*(Q6Kp-Q6K)
...
c     dT/dz*dfi/dteta
      DIFTP= DIFTP +KT(6,np)*Rhy*S6*c12*a23(6)*asr*(Q6Kp-Q6K)
